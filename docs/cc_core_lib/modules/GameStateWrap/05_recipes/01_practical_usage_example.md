...
### Recipe: Practical GameStateWrap Integration in Slot Games Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for Recipe: Practical GameStateWrap Integration in Slot Games.
