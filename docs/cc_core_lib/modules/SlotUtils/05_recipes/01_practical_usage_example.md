...
### Recipe: Practical SlotUtils Integration in Slot Games Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for Recipe: Practical SlotUtils Integration in Slot Games.
