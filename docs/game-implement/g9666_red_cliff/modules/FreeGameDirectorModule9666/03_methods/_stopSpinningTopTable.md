...
### FreeGameDirectorModule9666._stopSpinningTopTable Line-by-Line Method Walkthrough Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for FreeGameDirectorModule9666._stopSpinningTopTable Line-by-Line Method Walkthrough.
...
| :---: | :--- | :--- |
| **140** | `_stopSpinningTopTable(): Promise<void> {` | Method entry signature declaring `_stopSpinningTopTable()` returning `Promise<void>`. |
| **141** | `return this.moduleEvent.emit("TABLE_STOP_SPIN_TOP");` | Returns value or promise to calling sequence. |
