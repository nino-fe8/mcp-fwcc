...
### GameModeDirectorModule._showTransitionFreeGame() Method Specification Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for GameModeDirectorModule._showTransitionFreeGame() Method Specification.
