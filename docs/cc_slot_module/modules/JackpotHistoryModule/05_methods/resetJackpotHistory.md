...
### JackpotHistoryModule.resetJackpotHistory Method Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for JackpotHistoryModule.resetJackpotHistory Method.
