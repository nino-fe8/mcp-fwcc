...
### IntroGameModule.onCheckDoNotShowAgain Method Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for IntroGameModule.onCheckDoNotShowAgain Method.
