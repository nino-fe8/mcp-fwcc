...
### BetHistoryModule.enablePreviousBtn Method Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for BetHistoryModule.enablePreviousBtn Method.
