...
### BetHistoryDetailPortrait.activePreviousRespinBtn Method Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for BetHistoryDetailPortrait.activePreviousRespinBtn Method.
