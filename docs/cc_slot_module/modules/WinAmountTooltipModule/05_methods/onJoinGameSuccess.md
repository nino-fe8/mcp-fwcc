...
### WinAmountTooltipModule.onJoinGameSuccess Method Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for WinAmountTooltipModule.onJoinGameSuccess Method.
