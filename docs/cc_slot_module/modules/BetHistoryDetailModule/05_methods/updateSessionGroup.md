...
### BetHistoryDetailModule.updateSessionGroup Method Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for BetHistoryDetailModule.updateSessionGroup Method.
