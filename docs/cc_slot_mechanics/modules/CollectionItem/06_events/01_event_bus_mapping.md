...
### CollectionItem Event Bus Mapping & Subscriptions Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for CollectionItem Event Bus Mapping & Subscriptions.
