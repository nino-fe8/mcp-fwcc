...
### CollectionItemModuleConfig Subclassing Guide Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for CollectionItemModuleConfig Subclassing Guide.
