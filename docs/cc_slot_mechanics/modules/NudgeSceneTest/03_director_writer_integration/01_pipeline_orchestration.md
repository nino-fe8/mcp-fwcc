...
### NudgeSceneTest Pipeline Orchestration & Writer Commands Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for NudgeSceneTest Pipeline Orchestration & Writer Commands.
