...
### Recipe: Custom NudgeTableData Subclass Implementation Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for Recipe: Custom NudgeTableData Subclass Implementation.
