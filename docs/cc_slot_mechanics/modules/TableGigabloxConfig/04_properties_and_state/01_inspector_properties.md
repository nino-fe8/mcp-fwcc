...
### TableGigabloxConfig Inspector Properties & State Schema Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for TableGigabloxConfig Inspector Properties & State Schema.
