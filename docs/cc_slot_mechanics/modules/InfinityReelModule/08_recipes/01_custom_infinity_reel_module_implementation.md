...
### Recipe: Custom InfinityReelModule Subclass Implementation Summary

- **Core Architecture / Purpose**: Technical reference, API contract, and integration guide for Recipe: Custom InfinityReelModule Subclass Implementation.
